...
import { getPricingDetailById } from 'apiSdk/pricing-details';
...
function PricingDetailViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Pricing Detail Detail View
          </Text>
          {hasAccess('pricing_detail', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/pricing-details/edit/${data?.id}`} passHref legacyBehavior>
              <Button
